        ...
        <nav class="navbar header-navbar pcoded-header">
            <div class="navbar-wrapper">
                ...
                <div class="navbar-logo">
                    ...
                    <a href="index-1.htm">
                        <img class="img-fluid" src="{{ asset('asset/images/logo.png') }}" alt="Theme-Logo">
                    </a>
                ...
                <div class="navbar-container container-fluid">
                    ...
                    <ul class="nav-right">
                        <li class="header-notification">
                            <div class="dropdown-primary dropdown">
                                ...
                                <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="{{ asset('asset/images/avatar-4.jpg') }}" alt="Generic placeholder image">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="{{ asset('asset/images/avatar-3.jpg') }}" alt="Generic placeholder image">
                                            <div class="media-body">
                        ...
                        <li class="user-profile header-notification">
                            <div class="dropdown-primary dropdown">
                                <div class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="{{ asset('asset/images/avatar-4.jpg') }}" class="img-radius" alt="User-Profile-Image">
                                    <span>John Doe</span>
                        ...
                        <div class="main-friend-list">
                            <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius img-radius" src="{{ asset('asset/images/avatar-3.jpg') }}" alt="Generic placeholder image ">
                            ...
                            <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip" data-placement="left" title="Lary Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="{{ asset('asset/images/avatar-2.jpg') }}" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="{{ asset('asset/images/avatar-4.jpg') }}" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip" data-placement="left" title="Alia">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="{{ asset('asset/images/avatar-3.jpg') }}" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
        ...
        <div class="showChat_inner">
            ...
            <div class="media chat-messages">
                <a class="media-left photo-table" href="#!">
                    <img class="media-object img-radius img-radius m-t-5" src="{{ asset('asset/images/avatar-3.jpg') }}" alt="Generic placeholder image">
                </a>
            ...
            <div class="media chat-messages">
                ...
                <div class="media-right photo-table">
                    <a href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="{{ asset('asset/images/avatar-4.jpg') }}" alt="Generic placeholder image">
                    </a>
                </div>
            </div>
                ...
                <nav class="pcoded-navbar">
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="active">
                                <a href="editable-table.htm">
                                    ...
                                    <span class="pcoded-mtext">Editable Categories</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="">
                                <a href="{{ asset('extra-pages/landingpage/index.htm') }}" target="_blank">
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="{{ asset('extra-pages/email-templates/email-welcome.htm') }}">
                                                    <span class="pcoded-mtext">Welcome Email</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ asset('extra-pages/email-templates/email-password.htm') }}">
                                                    <span class="pcoded-mtext">Reset Password</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ asset('extra-pages/email-templates/email-newsletter.htm') }}">
                                                    <span class="pcoded-mtext">Newsletter Email</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ asset('extra-pages/email-templates/email-launch.htm') }}">
                                                    <span class="pcoded-mtext">App Launch</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ asset('extra-pages/email-templates/email-activation.htm') }}">
        ...
        <ul class="iew-download">
            <li>
                <a href="http://www.google.com/chrome/">
                    <img src="../files/asset/images/browser/chrome.png" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org/en-US/firefox/new/">
                    <img src="../files/asset/images/browser/firefox.png" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="http://www.opera.com">
                    <img src="../files/asset/images/browser/opera.png" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="https://www.apple.com/safari/">
                    <img src="../files/asset/images/browser/safari.png" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                    <img src="../files/asset/images/browser/ie.png" alt="">
                    <div>IE (9 & above)</div>
                </a>
            </li>
        </ul>
